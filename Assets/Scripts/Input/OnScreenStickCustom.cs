...
namespace Input
{
    ...
    public class OnScreenStickCustom : OnScreenControl, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        public Vector2ReactiveProperty PositionUpdate { get; private set; } = new Vector2ReactiveProperty();
        public ReactiveCommand OnRelease { get; private set; } = new ReactiveCommand();
        ...
        private void MoveStick(Vector2 pointerPosition, Camera uiCamera)
        {
            ...
            PositionUpdate.SetValueAndForceNotify(newPos);
